...
_C.MODEL.LANDMARKS_DIM = 68*2
_C.MODEL.ROTATION_NUM_LAYERS = 1
_C.MODEL.CRITIC_NUM_LAYERS = 1
...
_C.TRAIN.FINETUNE_CHECKPOINT = ""
_C.TRAIN.CENTER_IDENTITY_SIZE = 4
_C.TRAIN.CENTER_IDENTITY_STEP = 32
_C.TRAIN.ROTATION_BATCH_SIZE = 8
_C.TRAIN.LOGDIR = './logs_test/'
_C.TRAIN.N_EPOCHS = 1000
_C.TRAIN.CHECKPOINT_SAVE_STEP = 250
